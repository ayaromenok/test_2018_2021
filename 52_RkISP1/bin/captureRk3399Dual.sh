...
sleep 3
stop-gst-camera.sh
gst-launch-1.0 rkisp device=/dev/video5 io-mode=4 path-iqf=../cam_iq/ov4689_0.2.5.xml --gst-debug-level=$DBG_LEVEL num-buffers=$BUFFERS ! video/x-raw,format=NV12,width=640,height=360 ! jpegenc ! multifilesink location=./out/imageR_$FNAME.jpg &
sleep 3
stop-gst-camera.sh

...
{
    cv::Mat frame;
    cv::VideoCapture cap("rkcamsrc device=/dev/video0 io-mode=4 isp-mode=2A ! videoconvert ! video/x-raw,format=NV12,width=1296,height=972 ! appsink", cv::CAP_GSTREAMER);

...
testdata =  trdata.flow_from_directory(directory="data/validation", target_size=(112,112))
...
checkpoint = ModelCheckpoint("vgg16_112.h5", monitor='val_accuracy', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
...
img = image.load_img("image.jpg",target_size=(112,112))
img = np.asarray(img)
plt.imshow(img)
img = np.expand_dims(img, axis=0)

from keras.models import load_model
saved_model = load_model("vgg16_112.h5")
